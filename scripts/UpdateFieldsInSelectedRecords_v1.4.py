...
BND_OTHER = arcpy.GetParameterAsText(15)
CREATEDATE = arcpy.GetParameterAsText(16)
EDIT_DATE = arcpy.GetParameterAsText(17)
EDIT_BY = arcpy.GetParameterAsText(18)
ORIGINATOR = arcpy.GetParameterAsText(19)
CONSTRANT = arcpy.GetParameterAsText(20)
PROGRAM_COLLECTION = arcpy.GetParameterAsText(21)
